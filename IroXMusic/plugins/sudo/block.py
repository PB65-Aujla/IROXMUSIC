...
@app.on_message(filters.command(["block"]) & SUDOERS & LOVE)
@language
...
@app.on_message(filters.command(["unblock"]) & SUDOERS & LOVE)
@language
...
@app.on_message(filters.command(["blocked", "blockedusers", "blusers"]) & SUDOERS & LOVE)
@language
